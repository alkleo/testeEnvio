...
// Alterar a linha anterior por  se estiver usando ESP32
// Incluir esta biblioteca se estiver usando ESP32

WiFiClientSecure client;//Cria um cliente seguro (para ter acesso ao HTTPS)
String textFix = "GET /forms/d/e/1FAIpQLSccqDZ1AF2GXUP1ial-e5wfl-k-INu7xBXqqrgIN7QdIVbr0A/formResponse?ifq&entry.55065668=";
